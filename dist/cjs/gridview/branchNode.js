...
var BranchNode = /** @class */ (function (_super) {
    ...
    function BranchNode(orientation, proportionalLayout, styles, size, orthogonalSize, disabled, margin, childDescriptors) {
        ...
        _this._onDidSashChange = new events_1.Emitter();
        ...
        _this.addDisposables(_this._onDidChange, _this._onDidSashChange, _this._onDidVisibilityChange, _this.splitview.onDidSashEnd(function () {
            _this._onDidSashChange.fire(undefined);
    ...
    BranchNode.prototype.setupChildrenEvents = function () {
        ...
        this._childrenDisposable = new (lifecycle_1.CompositeDisposable.bind.apply(lifecycle_1.CompositeDisposable, __spreadArray([void 0, events_1.Event.any.apply(events_1.Event, __spreadArray([], __read(this.children
                .filter(function (c) { return c instanceof BranchNode; })
                .map(function (c) { return c.onDidSashChange; })), false))(function (e) {
                _this._onDidSashChange.fire(undefined);
            }),
            events_1.Event.any.apply(events_1.Event, __spreadArray([], __read(this.children.map(function (c) { return c.onDidChange; })), false))(function (e) {
                /**
