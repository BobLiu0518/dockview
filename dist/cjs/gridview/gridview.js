...
var Gridview = /** @class */ (function () {
    function Gridview(proportionalLayout, styles, orientation, locked, margin) {
        ...
        this._onDidSashChange = new events_1.Emitter();
    ...
    Object.defineProperty(Gridview.prototype, "root", {
        ...
        set: function (root) {
            ...
            this.disposable.value = new lifecycle_1.CompositeDisposable(this._root.onDidChange(function (e) {
                _this._onDidChange.fire(e);
            }), this._root.onDidSashChange(function (e) {
                _this._onDidSashChange.fire(e);
            }));
        },
        enumerable: false,
        configurable: true
