...
var PaneviewComponent = /** @class */ (function (_super) {
    ...
    function PaneviewComponent(container, options) {
        ...
        _this.addDisposables(_this._disposable, _this._onDidAddView, _this._onDidRemoveView, _this._onDidLayoutfromJSON, _this._onDidLayoutChange, _this._onDidSashChange, _this._onDidDrop, _this._onUnhandledDragOverEvent);
        return _this;
    }
    ...
    Object.defineProperty(PaneviewComponent.prototype, "paneview", {
        ...
        set: function (value) {
            ...
            this._disposable.value = new lifecycle_1.CompositeDisposable(this._paneview.onDidSashChange(function () {
                _this._onDidSashChange.fire(undefined);
            }), this._paneview.onDidChange(function () {
