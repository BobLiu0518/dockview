import type { DockviewGroupPanel, IContentRenderer, IGroupHeaderProps, IHeaderActionsRenderer, ITabRenderer, IWatermarkRenderer, PanelUpdateEvent, Parameters, TabPartInitParameters, WatermarkRendererInitParameters } from '@bobliu0518/dockview-core';
...
export declare class VuePart<T extends Record<string, any> = any> {
    ...
    private props;
    private _renderDisposable;
    constructor(element: HTMLElement, vueComponent: VueComponent<T>, parent: ComponentInternalInstance, props: T);
    init(): void;
    update(props: T): void;
    dispose(): void;
}
